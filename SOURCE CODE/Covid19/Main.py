...
main = Tk()
main.title("Machine Learning Based Approaches for Detecting COVID-19 using Clinical Text Data")
...
font = ('times', 15, 'bold')
title = Label(main, text='Machine Learning Based Approaches for Detecting COVID-19 using Clinical Text Data')
